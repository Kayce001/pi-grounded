...
> | **M2 度量与打包** | 🟠 **部分完成** —— 打包验证通过；基线 A/B 因 Codex 配额耗尽只跑了 A 2/12、B 7/12 |
>
> **本文档是设计意图的记录，不是实际结果的记录。**
> 实际做成什么样、偏离了哪些、哪些没验证 → 看 [`HANDOFF.md`](HANDOFF.md)；实测数据 → 看 [`NOTES.md`](NOTES.md)；自己验收 → 看 [`VERIFY.md`](VERIFY.md)。
